...
def TrimSecondaryNameForMC(dataset):
  ...
  #
  name = name.replace("RunIISummer20UL16NanoAODAPVv9-","MCUL16APVJMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
  name = name.replace("20UL16APVJMENano_106X_mcRun2_asymptotic_preVFP_v11","") #REMOVE GT. CHECK ITS UPDATED
  #
  name = name.replace("RunIISummer20UL16NanoAODv9-","MCUL16JMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
  name = name.replace("20UL16JMENano_106X_mcRun2_asymptotic_v17","") #REMOVE GT. CHECK ITS UPDATED
  #
  name = name.replace("RunIISummer20UL17NanoAODv9-","MCUL17JMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
  name = name.replace("20UL17JMENano_106X_mc2017_realistic_v9","") #REMOVE GT. CHECK ITS UPDATED
  #
  name = name.replace("RunIISummer20UL18NanoAODv9-","MCUL18JMENanoAODv9")#RENAME CAMPAIGN. CHECK ITS UPDATED
...
def TrimSecondaryNameForData(dataset):
  name = dataset.split('/')[2]
  #
  name = name.replace("HIPM_UL2016_MiniAODv2_JMENanoAODv9","DataUL16APVJMENanoAODv9") #CHECK
  name = name.replace("UL2016_MiniAODv2_JMENanoAODv9","DataUL16JMENanoAODv9") #CHECK
  name = name.replace("UL2017_MiniAODv2_JMENanoAODv9","DataUL17JMENanoAODv9") #CHECK
  name = name.replace("UL2018_MiniAODv2_JMENanoAODv9","DataUL18JMENanoAODv9") #CHECK
  #
  name = name.replace("-v1","")# 
  name = name.replace("-v2","")# 
  name = name.replace("-v3","")#
